    ...
    <div>
      ...
      <div>
        ...
        <p className="mt-2 text-sm leading-6 text-black/45">
          Submit your GitHub work and LinkedIn post to complete today's
          challenge.
        </p>
      </div>
      ...
      <div className="mt-7">
        <div className="mb-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#111] text-white">
              <span className="text-lg font-black">GH</span>
            </div>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={!githubUrl}
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#111] text-white transition hover:bg-[#222] disabled:cursor-not-allowed disabled:opacity-30"
          >
